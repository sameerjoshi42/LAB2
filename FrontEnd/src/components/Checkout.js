...
const Checkout = () => {
    ...
    useEffect(()=>{
        const url ="http://3.128.29.95:3002/getcustaddressesMongo";
    ...
    const saveAddress = ()=>{
        ...
        window.location.reload();
            ...
            const url ="http://3.128.29.95:3002/addaddressMongo";
    ...
    const placeOrder = (e)=>{
        var data="";
        e.preventDefault();
        const url ="http://3.128.29.95:3002/placeOrderMongo";
        var dt = new Date();
        ...
        Axios.post(url,{cust_name:cust_name,
            ...
            delivery_instructions:instructions
                ...
                Axios.post('http://3.128.29.95:3002/saveOrderDetailsMongo',{
                    order_id:data,
